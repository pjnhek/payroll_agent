...
- [x] 20-17-PLAN.md — Scope sent-proof lookup to the run's current epoch

**Wave 12** *(gap closure; blocked on Wave 11 completion)*

- [x] 20-18-PLAN.md — Fence stale-epoch send jobs before provider and settlement work
...
- [x] 20-20-PLAN.md — Enforce confirmation-only review actions and finish quality gates
...
- [x] 20-27-PLAN.md — Repair fresh/deployed attempt-category parity and complete the blocking guarded live-Postgres schema/expiry/provider-handoff evidence gate; unavailable credentials or any skip do not close the phase.
...
- [x] 21-01-PLAN.md — Proof identity substrate: register the `proof` marker and build the completeness checker's pure decision core with its synthetic red-proofs (PROOF-05)
- [x] 21-02-PLAN.md — Queue-metric reads and the D-13 unaccounted-error alarm predicate, proven against a real Postgres on both sides (OPS-01)
...
- [x] 21-08-PLAN.md — PROOF-04 rewritten as a genuine two-thread race, plus the reclaim-clause mutation executed live (PROOF-04)
